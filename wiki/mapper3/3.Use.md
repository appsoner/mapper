...
8. 实体类可以继承使用,可以参考测试代码中的`cn.terminus.mapper.model.UserLogin2`类.
...
```xml
<mappers>
  <mapper class="cn.terminus.mapper.mapper.CountryMapper" />
  <mapper class="cn.terminus.mapper.mapper.UserInfoMapper" />
  <mapper class="cn.terminus.mapper.mapper.UserLoginMapper" />
</mappers>
```
...
<bean class="cn.terminus.spring.mapper.MapperScannerConfigurer">
  ...
  <property name="markerInterface" value="cn.terminus.mapper.common.Mapper"/>
</bean>
```
